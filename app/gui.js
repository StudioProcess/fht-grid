...
export function create() {
  ...
  gui.add(main.params, 'label_padding_x', 0, undefined, 0.1).onFinishChange(main.recreate);
  gui.add(main.params, 'label_padding_y', 0, undefined, 0.1).onFinishChange(main.recreate);
